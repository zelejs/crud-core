 ...
 */
package com.jfeat.crud.core.util;
...
public class HttpKit {
    ...
    public static String sendGet(String url, Map<String, String> param, Map<String, String> headers) {
        ...
        try {
            ...
            logger.info("GET URL : {}", realUrl.toString());
            // 打开和URL之间的连接
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendPost(String url, Map<String, String> param, Map<String, String> headers) {
        ...
        try {
            ...
            String urlNameString = url + "?" + para;
            URL realUrl = new URL(urlNameString);
            logger.info("POST URL : {}", realUrl.toString());
            // 打开和URL之间的连接
